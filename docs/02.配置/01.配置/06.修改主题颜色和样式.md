...
下面是jingli主题使用的css变量，你可以在`.vuepress/styles/palette.styl`修改这些变量覆盖它们：
...
.theme-mode-read
  ...
  codeThemeDark()
```
上面的变量值可能不是最新的，最新的变量值可查看：[palette.styl](https://github.com/roinli/vuepress-theme-jingli/blob/master/theme-jingli/styles/palette.styl)
