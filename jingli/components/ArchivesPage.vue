<template>
  <div class="custom-page archives-page">
    <div class="theme-jingli-wrapper">
      <h1>
        <img
          :src="currentBadge"
...
.theme-style-line
  .archives-page .theme-jingli-wrapper
    box-shadow 0 0
    // border 1px solid var(--borderColor)
    // border-radius 5px
.archives-page
  .theme-jingli-wrapper
    @extend $jingli-wrapper
    position relative
    ...
    .loadmore
      ...
      margin-top 1rem
      opacity 0.5
.theme-mode-dark .archives-page .theme-jingli-wrapper li a:hover, .theme-mode-read .archives-page .theme-jingli-wrapper li a:hover
