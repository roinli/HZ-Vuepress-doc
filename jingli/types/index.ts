...
/**
 * jingli主题配置类型
 * @see https://doc.roinli.com/
 */
export interface jingliThemeConfig extends NoSidebar4DefaultThemeConfig {
  /**
  ...
  /**
   * 社交图标 (显示于博主信息栏和页脚栏)
   * @内置图标-see：https://doc.roinli.com/pages/a20ce8/#social
   */
  social?: {
  ...
  /**
   * 自定义hmtl(广告)模块
   * @see: https://doc.roinli.com/pages/a20ce8/#htmlmodules
   */
  htmlModules?: {
    homeSidebarB?: string,
    sidebarT?: string,
