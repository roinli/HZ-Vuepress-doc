...
::: note
Markdown的基本语法就不再重复啦 (对Markdown不了解的可以看 [这里](https://roinli.com/pages/ad247c4332211551/)),
...
```text
jingli是一款简洁高效的 <mark>知识管理&博客</mark> 主题
```
jingli是一款简洁高效的 <mark> 知识管理&博客 </mark> 主题
...
```markdown
![npm](https://img.shields.io/npm/v/vuepress-theme-jingli)
![star](https://img.shields.io/github/stars/roinli/vuepress-theme-jingli)
```
![npm](https://img.shields.io/npm/v/vuepress-theme-jingli)
![star](https://img.shields.io/github/stars/roinli/vuepress-theme-jingli)
...
```html
<iframe height="400" style="width: 100%;" scrolling="no" title="【CSS：行为】使用:hover和attr()定制悬浮提示" src="https://codepen.io/roinli/embed/vYNKNaq?height=400&theme-id=light&default-tab=css,result" frameborder="no" allowtransparency="true" allowfullscreen="true" loading="lazy">
  See the Pen <a href='https://codepen.io/roinli/pen/vYNKNaq'>【CSS：行为】使用:hover和attr()定制悬浮提示</a> by roinli
  (<a href='https://codepen.io/roinli'>@roinli</a>) on <a href='https://codepen.io'>CodePen</a>.
</iframe>
```
<iframe height="400" style="width: 100%;" scrolling="no" title="【CSS：行为】使用:hover和attr()定制悬浮提示" src="https://codepen.io/roinli/embed/vYNKNaq?height=400&theme-id=light&default-tab=css,result" frameborder="no" allowtransparency="true" allowfullscreen="true" loading="lazy">
  See the Pen <a href='https://codepen.io/roinli/pen/vYNKNaq'>【CSS：行为】使用:hover和attr()定制悬浮提示</a> by roinli
