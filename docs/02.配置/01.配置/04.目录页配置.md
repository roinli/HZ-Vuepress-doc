...
module.exports = {
    themeConfig: {
        nav:  [
          ...
          // 有二级导航时
           {text: '页面',
               link: '/ui/',   //目录页， jingli主题新增的配置项，有二级导航时，可以点击一级导航跳到目录页
               items: [
...
```
参考：[.vuepress/config/nav.js](https://github.com/roinli/vuepress-theme-jingli/blob/master/docs/.vuepress/config/nav.js)
