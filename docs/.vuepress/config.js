...
module.exports = {
  ...
  // theme: 'jingli', // 使用依赖包主题
  theme: require.resolve('../../jingli'), // 使用本地主题 (先将jingli主题文件下载到本地：https://github.com/roinli/vuepress-theme-jingli)

  title: "鲸哩文档 | JINGLI  ",
  description: 'JINGLI | 企业级开源充电桩平台',
  // base: '/', // 默认'/'。如果你想将你的网站部署到如 https://foo.github.io/bar/，那么 base 应该被设置成 "/bar/",（否则页面将失去样式等文件）
  head: [ // 注入到页面<head> 中的标签，格式[tagName, { attrName: attrValue }, innerHTML?]
    ['link', { rel: 'icon', href: '/img/favicon.ico' }], //favicons，资源放在public文件夹
    ['meta', { name: 'keywords', content: 'vuepress,theme,blog,jingli' }],
  ...
  { text: '主题初衷与诞生', link: '/pages/52d5c3/' },
      ...
      { text: 'Gitee', link: 'https://gitee.com/jingli1234/charge-pile-saas-system' },
    ],
    sidebarDepth: 2, // 侧边栏显示深度，默认1，最大2（显示到h3标题）
    logo: '/img/logo.png', // 导航栏logo
    repo: 'roinli/charge-pile-saas-system', // 导航栏右侧生成Github链接
    ...
    author: { // 文章默认的作者信息，可在md文件中单独配置此信息 String | {name: String, href: String}
      name: 'wenhui', // 必需
      href: 'https://github.com/roinli' // 可选的
    },
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:544061884@qq.com'
        },
        {
          iconClass: 'icon-github',
          title: 'GitHub',
          link: 'https://github.com/roinli'
        },
        {
          iconClass: 'icon-erji',
          title: '听音乐',
    ...
    footer: { // 页脚信息
      ...
      copyrightInfo: 'JINGLI 鲸哩 | MIT License', // 博客版权信息，支持a标签
    },
    htmlModules,
  },
  ...
  plugins: [
    ...
    //   excludeClassName: 'theme-jingli-content' // 要排除元素的class, 默认空''
    // }],
    ...
    [
      ...
      {
        selector: '.theme-jingli-content img:not(.no-zoom)',
        options: {
